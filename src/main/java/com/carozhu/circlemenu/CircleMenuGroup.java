 ...
 * folk from https://github.com/xiayezhicheng/CircleMenu.git,thasnks
 * <p>
 * optimation by caro
 */
public class CircleMenuGroup extends ViewGroup {

    private final static String TAG = "CircleMenuGroup";
    ...
    public void setdAdapter(ListAdapter myAdapter) {
        ...
        for (int i = 0; i < mAdapter.getCount(); i++) {
            ...
            itemView.setOnLongClickListener(new OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    if (mOnMenuItemClickListener != null)
                        mOnMenuItemClickListener.itemlongClick(v, position);
                    return false;
                }
            });
            addView(itemView);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        Log.i(TAG, "onLayout,mAdapter.getCount() == " + mAdapter.getCount());
